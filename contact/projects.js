    ...
    projects.forEach((project) => {
      ...
      article.innerHTML = `
            ...
            <a href="${project["Website link"]}" target="_blank">
              <${headingLevel}>${project["org name"]}</${headingLevel}>
            </a>
            <div class="wrapper">
              <div class="description">${project.description}</div>
              <div class="year">${project["topic / category"]}</div>
            </div>
            <br>
            <img src="${project.image}" alt="${project["org name"]}" height="200" width="280" padding="10" />
...
let projects = await fetchJSON("../json_files/orgs.json");
